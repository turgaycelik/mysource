...
public class TestTrustedApplicationClientVersion1 extends JIRAWebTest
{
    static
    {
        try
    ...
    {
        assertEquals("BAD_PROTOCOL_VERSION; Unsupported protocol version: {0}. required {1}; [\"1\",\"2\"]", response.getHeaderField(TrustedAppHeader.ERROR));
    }
    ...
    private static class Token
    {
        ...
        private static final class KeyData
        {
            ...
            private static final String MAGIC_NUMBER = String.valueOf(0xBADC0FEE);
        }
        ...
        void populateRequest(String userName, GetMethodWebRequest request)
        {
            ...
            request.setHeaderField(TrustedAppHeader.VERSION, String.valueOf(1));
            request.setHeaderField(TrustedAppHeader.MAGIC, encrypt(KeyData.MAGIC_NUMBER.getBytes()));
        }
