...
<ww:property value="parameters['disabled']">
    <ww:if test="hasPermission('pickusers') == true">
        <a class="popup-trigger" href="#"><span class="aui-icon icon-userpicker" title="<ww:if test="parameters['multiSelect'] == true"><ww:text name="'user.picker.select.users'"/></ww:if><ww:else><ww:text name="'user.picker.select.user'"/></ww:else>"></span></a>
    </ww:if>
    <ww:else>
