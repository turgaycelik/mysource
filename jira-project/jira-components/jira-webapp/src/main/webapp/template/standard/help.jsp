...
<ww:property value="@helpUtil/helpPath(parameters['name'])">
    <ui:soy moduleKey="'jira.webresources:soy-templates'" template="'JIRA.Templates.Links.helpLink'">
        ...
        <ui:param name="'url'"><ww:property value="url"/></ui:param>
        <ui:param name="'fragmentIdentifier'"><ww:property value="parameters['helpURLFragment']" /></ui:param>
        <ww:if test="parameters['noalign'] != true">
            <ui:param name="'extraAttributes'">
                <ww:property value="parameters['align']">
                    <ww:if test=".">
                        <ww:if test=". == 'right'">style="float:right;"</ww:if>
                        <ww:if test=". == 'left'">style="float:left;"</ww:if>
                    </ww:if>
                    <ww:else>style="float: right;"</ww:else>
                </ww:property>
            </ui:param>
        </ww:if>
    </ui:soy>
