...
<head>
	...
	<title><ww:text name="'admin.issuefields.screenschemes.copy.screen.scheme'"/></title>
</head>
<body>
<page:applyDecorator name="jiraform">
    <page:param name="action">CopyFieldScreenScheme.jspa</page:param>
    ...
    <page:param name="title"><ww:text name="'admin.issuefields.screenschemes.copy.screen.scheme'"/></page:param>
    <page:param name="width">100%</page:param>
    <page:param name="description">
        <p>
            <ww:text name="'admin.issuefields.screenschemes.copy.instruction'">
