...
<html>
<head>
    <title><ww:text name="'admin.scheme.picker.comparison.title'"/></title>
...
<page:applyDecorator name="jiraform">
    ...
    <page:param name="title"><ww:text name="'admin.scheme.picker.comparison.title'"/></page:param>
    <page:param name="helpURL">scheme_tools</page:param>
    <page:param name="description"><ww:text name="'admin.scheme.picker.comparison.desc'">
       <ww:param name="'value0'"><p/></ww:param>
       <ww:param name="'value1'"><ww:property value="/maxNumberOfSchemesToCompare" /></ww:param>
    </ww:text>
    </page:param>
    <page:param name="action">SchemeComparisonPicker.jspa</page:param>
    <page:param name="columns">1</page:param>
    <page:param name="submitId">compare_submit</page:param>
    <page:param name="submitName"><ww:text name="'admin.scheme.picker.comparison.submit'"/></page:param>
    <tr>
        <td>
