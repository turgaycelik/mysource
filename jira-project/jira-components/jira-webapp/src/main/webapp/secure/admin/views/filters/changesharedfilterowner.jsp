...
<head>
    ...
    <title><ww:text name="'sharedfilters.admin.changeowner.title'"/></title>
</head>
<body>
    ...
    <page:applyDecorator id="change-owner" name="auiform">
        ...
        <page:param name="id">change-owner-form-<ww:property value="filterId" /></page:param>
        <page:param name="submitButtonName">ChangeOwner</page:param>
        <page:param name="submitButtonText"><ww:text name="'sharedfilters.admin.cog.changeowner'"/></page:param>
        <page:param name="cancelLinkURI"><ww:url value="'/secure/ViewSharedFilters.jspa'" atltoken="false"/></page:param>
        <page:param name="returnUrl"><ww:property value="./returnUrl"/></page:param>
        <aui:component template="formHeading.jsp" theme="'aui'">
            <aui:param name="'text'"><ww:text name="'sharedfilters.admin.changeowner.heading'"><ww:param name="'value0'"><ww:property value="filterName" /></ww:param></ww:text></aui:param>
            <aui:param name="'escape'" value="'false'" />
        </aui:component>
        <page:applyDecorator name="auifieldgroup">
            <page:param name="id">owner-container</page:param>
            <aui:component label="text('sharedfilters.admin.filter.owner')" name="'owner'" id="'owner'" template="singleSelectUserPicker.jsp" theme="'aui'">
