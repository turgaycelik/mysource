...
import com.atlassian.jira.charts.report.ResolutionTimeReport;
...
public class TestResolutionTimeReport extends AbstractChartReportTestCase
{
    ...
    {
        return new ResolutionTimeReport(null, applicationProperties, projectManager, searchRequestService,
    ...
    public void testGenerateReportHtml() throws Exception
    {
        ...
        when(mockChartFactory.generateDateRangeTimeChart(context, 30, ChartFactory.PeriodName.weekly, DateUtils.DAY_MILLIS, "datacollector.daystoresolve", "resolutiondate"))
        ...
        when(mockReportModuleDescriptor.getHtml("view", EasyMap.build("user", null,
                "action", null, "report", resolutionTimeReport,
