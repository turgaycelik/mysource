...
import com.atlassian.jira.charts.report.TimeSinceReport;
...
public class TestTimeSinceReport extends AbstractChartReportTestCase
{
    ...
    public void testGenerateReportHtml() throws Exception
    {
        ...
        when(mockChartFactory.generateTimeSinceChart(context, 30, PeriodName.weekly, false, "updated"))
        ...
        when(mockReportModuleDescriptor.getHtml("view", EasyMap.build("user", null,
                "action", null, "report", timeSinceReport,
        ...
        Map<String, Object> params = MapBuilder.<String, Object>build("projectOrFilterId", "filter-123", "periodName", "weekly", "dateField", "updated");
