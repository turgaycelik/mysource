 ...
 * @since v4.3
 */
public class EndOfDayFunction extends AbstractDateFunction
{
    public static final String FUNCTION_END_OF_DAY = "endOfDay";
    
    EndOfDayFunction(final Clock clock, final TimeZoneManager timeZoneManager)
    {
        super(clock, timeZoneManager);
    }

    public EndOfDayFunction(final TimeZoneManager timeZoneManager)
    {
