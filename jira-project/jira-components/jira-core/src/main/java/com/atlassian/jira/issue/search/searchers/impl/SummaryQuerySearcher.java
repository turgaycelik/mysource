 ...
 * @since v5.2
 */
public class SummaryQuerySearcher implements IssueSearcher<SearchableField>
{

    private static final String NAME_KEY = "issue.field.summary";

    private static final List<Class<? extends FieldIndexer>> SUMMARY_INDEXER = CollectionBuilder.<Class<? extends FieldIndexer>>newBuilder(SummaryIndexer.class).asList();
    ...
    public SummaryQuerySearcher(final JqlOperandResolver operandResolver, final VelocityRequestContextFactory velocityRequestContextFactory,
    ...
    {
        final SimpleFieldSearchConstants fieldInfo = SystemSearchConstants.forSummary();
