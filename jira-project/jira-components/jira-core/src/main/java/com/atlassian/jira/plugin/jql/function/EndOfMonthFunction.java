...
{
    public static final String FUNCTION_END_OF_MONTH = "endOfMonth";
    EndOfMonthFunction(final Clock clock, final TimeZoneManager timeZoneManager)
    {
        super(clock, timeZoneManager);
    }

    public EndOfMonthFunction(final TimeZoneManager timeZoneManager)
    {
