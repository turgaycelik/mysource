 ...
 * This maps to the LHS of JQL query "environment ~ foo".
 *
 * @since v5.2
 */
public class EnvironmentQuerySearcher implements IssueSearcher<SearchableField>
{

    private static final String NAME_KEY = "issue.field.environment";

    private static final List<Class<? extends FieldIndexer>> INDEXER = CollectionBuilder.<Class<? extends FieldIndexer>>newBuilder(EnvironmentIndexer.class).asList();
    ...
    public EnvironmentQuerySearcher(final JqlOperandResolver operandResolver, final VelocityRequestContextFactory velocityRequestContextFactory,
            ...
            final FieldVisibilityManager fieldVisibilityManager)
    {
        ...
        final SimpleFieldSearchConstants fieldInfo = SystemSearchConstants.forEnvironment();
        this.searcherInformation = new GenericSearcherInformation<SearchableField>(fieldInfo.getSearcherId(), NAME_KEY, INDEXER, fieldRef, SearcherGroupType.TEXT);
