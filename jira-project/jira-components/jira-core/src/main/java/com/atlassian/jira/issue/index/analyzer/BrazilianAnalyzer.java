 ...
 */
public class BrazilianAnalyzer extends TextAnalyzer
{
    ...
    public BrazilianAnalyzer(Version matchVersion, final boolean indexing, Function<TokenStream, TokenStream> stemmingFilter,
