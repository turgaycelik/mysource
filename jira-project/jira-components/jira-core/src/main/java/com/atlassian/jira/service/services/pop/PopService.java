...
/**
 * This class remains here only to prevent alarming exceptions from occuring during system upgrade. Please don't use it
 * for any purpose, extend the MailFetcherService class directly.
 *
 * @deprecated Use MailFetcherService directly
 */
@Deprecated
@Internal
public class PopService extends AbstractService
{
    @Override
