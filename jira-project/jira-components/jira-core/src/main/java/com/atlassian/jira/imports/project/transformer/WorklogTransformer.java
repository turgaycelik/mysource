...
/**
 * Used to transform an ExternalWorklog based on the project import mapper that is provided. This should only be
...
{
    /**
     * Transforms an ExternalWorklog based on the project import mapper that is provided. This should only be
     * used with a fully mapped and validated ProjectImportMapper.
     ...
     * @param worklog the external worklog that contains all the old values that need to be transformed and other values
     * that should be stored that need no transformation.
     * @return a new ExternalWorklog that contains the transformed values based on the projectImportMapper.
     */
