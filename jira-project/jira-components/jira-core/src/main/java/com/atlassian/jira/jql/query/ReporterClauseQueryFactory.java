 ...
 * @since v4.0
 */
public class ReporterClauseQueryFactory implements ClauseQueryFactory
{
    private final ClauseQueryFactory delegateClauseQueryFactory;

    public ReporterClauseQueryFactory(UserResolver userResolver, JqlOperandResolver operandResolver)
    {
        final UserFieldSearchConstantsWithEmpty searchConstants = SystemSearchConstants.forReporter();
